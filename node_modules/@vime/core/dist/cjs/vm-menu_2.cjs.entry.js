...
function menuItemHunter(assignedElements) {
  if (withComponentRegistry.isUndefined(assignedElements))
    return [];
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.vmOpen = index.createEvent(this, "vmOpen", 7);
    this.vmClose = index.createEvent(this, "vmClose", 7);
    this.vmFocus = index.createEvent(this, "vmFocus", 7);
    this.vmBlur = index.createEvent(this, "vmBlur", 7);
    this.vmActiveSubmenuChange = index.createEvent(this, "vmActiveSubmenuChange", 7);
    this.vmActiveMenuItemChange = index.createEvent(this, "vmActiveMenuItemChange", 7);
    this.vmMenuHeightChange = index.createEvent(this, "vmMenuHeightChange", 3);
  ...
  onOpenSubmenu(event) {
    ...
    if (!withComponentRegistry.isUndefined(this.activeSubmenu))
  ...
  focusController() {
    var _a, _b, _c, _d, _e;
    if (!withComponentRegistry.isUndefined((_a = this.controller) === null || _a === void 0 ? void 0 : _a.focusItem)) {
      (_b = this.controller) === null || _b === void 0 ? void 0 : _b.focusItem();
    }
    else if (!withComponentRegistry.isUndefined((_c = this.controller) === null || _c === void 0 ? void 0 : _c.focusControl)) {
  ...
  triggerMenuItem() {
    var _a;
    if (withComponentRegistry.isUndefined(this.activeMenuItem))
      return;
  ...
  render() {
    var _a, _b, _c;
    return (index.h("div", { id: this.identifier, class: {
        menu: true,
        slideIn: !withComponentRegistry.isUndefined(this.slideInDirection),
...
const MenuItem = class {
  ...
  onClick() {
    if (!withComponentRegistry.isNil(this.menu))
  ...
  render() {
    var _a, _b, _c, _d;
    const isCheckedDefined = !withComponentRegistry.isUndefined(this.checked);
    const isMenuDefined = !withComponentRegistry.isUndefined(this.menu);
    const hasExpanded = this.expanded ? 'true' : 'false';
    const isChecked = this.checked ? 'true' : 'false';
    const showCheckedIcon = isCheckedDefined && !withComponentRegistry.isUndefined(this.checkIcon);
    const showLeftNavArrow = isMenuDefined && this.expanded;
    const showRightNavArrow = isMenuDefined && !this.expanded;
    const showHint = !withComponentRegistry.isUndefined(this.hint) &&
      !isCheckedDefined &&
      (!isMenuDefined || !this.expanded);
    const showBadge = !withComponentRegistry.isUndefined(this.badge) && !showHint && !showRightNavArrow;
    ...
    return (index.h("div", { class: {
        ...
        this.menuItem = el;
      } }, showCheckedIcon && (index.h("vm-icon", { name: this.checkIcon, library: this.icons })), showLeftNavArrow && index.h("span", { class: "arrow left" }), this.label, hasSpacer && index.h("span", { class: "spacer" }), showHint && index.h("span", { class: "hint" }, this.hint), showBadge && index.h("span", { class: "badge" }, this.badge), showRightNavArrow && index.h("span", { class: "arrow right" })));
  }
  get host() { return index.getElement(this); }
};
MenuItem.style = menuItemCss;

exports.vm_menu = Menu;
exports.vm_menu_item = MenuItem;
