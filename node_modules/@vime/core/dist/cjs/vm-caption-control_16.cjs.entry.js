...
const SettingsControl = class {
  ...
  render() {
    ...
    return (index.h("div", { class: {
      ...
      } }, index.h("vm-icon", { name: this.icon, library: this.icons }), index.h("vm-tooltip", { hidden: this.expanded, position: this.tooltipPosition, direction: this.tooltipDirection }, this.i18n.settings))));
  }
  get host() { return index.getElement(this); }
  static get watchers() { return {
